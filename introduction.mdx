...
4. When upstream skills change, you **fetch** the latest and **sync** projects
...
- **Open source skills stay in sync.** Run `reseed fetch` to pull the latest versions from GitHub.
